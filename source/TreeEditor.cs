...
{
	/// <summary>
	/// Summary description for TreeEditor.
	/// </summary>
	
	public class ChooseNewNoteFormatEventArgs : KeyEventArgs 
	{
		public string SelectedNewNoteFormat = NoteFormat.FORMAT_TEXT;
		public ChooseNewNoteFormatEventArgs(KeyEventArgs e) : base(e.KeyData)
		{
	...
	public delegate void ChooseNewNoteFormatHandler(object sender, ChooseNewNoteFormatEventArgs e);
	public class TreeEditor : System.Windows.Forms.TreeView 
	{
		public event TreeReloadHandler TreeReload = null;
		public event ChooseNewNoteFormatHandler ChooseNewNoteFormat = null;
		public readonly string InstanceId = "";

		private NotepadXDocument m_NotepadXDocument = null;
		...
		protected void RaiseChooseNewNoteFormatEvent(ChooseNewNoteFormatEventArgs e)
		{
			OnChooseNewNoteFormat(e);
			if (ChooseNewNoteFormat != null) ChooseNewNoteFormat(this, e);
		}
		protected virtual void OnTreeReload(EventArgs e)
		{
		}
		protected virtual void OnChooseNewNoteFormat(ChooseNewNoteFormatEventArgs e)
		{
		}
		#endregion
		
		public NotepadXDocument CatNoteDocumentToUse
		{
			get
			{
		...
		public CatNoteDetail GetCatNoteDetailForSelectedNode()
		{
			return GetCatNoteDetailForNode(this.SelectedNode);
		}
		...
		public CatNoteDetail GetCatNoteDetailForNode(TreeNode thisNode)
		{
			if (thisNode != null)
			{
		...
		private void base_AfterLabelEdit(object sender, System.Windows.Forms.NodeLabelEditEventArgs e)
		{
			...
			if ((e.Node != null) && (e.Label != null))
			{
				...
				CatNoteDetail selectedCatNoteDetail = m_NotepadXDocument.GetNoteById(selectedNodeId);
		...
		public void StartNodeTitleEdit(TreeNode nodeToEdit)
		{
			...
			if (nodeToEdit != null)
			{
				if (GetCatNoteDetailForNode(nodeToEdit).IsReadOnly == false)
		...
		private void base_KeyUp(object sender, System.Windows.Forms.KeyEventArgs e)
		{
			...
			if (m_NotepadXDocument.IsReadonly==false)
			{
				...
				{
					ChooseNewNoteFormatEventArgs newNoteFormatEventArgs = new ChooseNewNoteFormatEventArgs(e);
					RaiseChooseNewNoteFormatEvent(newNoteFormatEventArgs);
					AddNewChildNoteForSelectedNode(newNoteFormatEventArgs.SelectedNewNoteFormat);
				}
		...
		private void base_ItemDrag(object sender, System.Windows.Forms.ItemDragEventArgs e)
		{
			...
			CatNoteDetail noteForDraggedNode = GetCatNoteDetailForNode(draggedNode);
		...
		private void base_DragDrop(object sender, System.Windows.Forms.DragEventArgs e)
		{
			...
			else if (e.Data.GetDataPresent(typeof(string))==true)
			{
				...
				if (draggedText != null)
				{
					...
					{
						AddNewChildNoteForTreeNode(destinationNoteId, draggedText, NoteFormat.FORMAT_DEFAULT);
					}
				}
				else
				{
		...
		private void UpdateNodeFromCatNoteDetail(TreeNode nodeToUpdate, CatNoteDetail sourceNote)
		{
		...
		public TreeNode CreateTreeNodeForCatNoteDetail(TreeNodeCollection  parentTreeNodeCollection, CatNoteDetail thisCatNoteDetail)
		{
		...
		public void UpdateTreeNode(CatNoteDetail noteDetail)
		{
		...
		{
			//Get child notes
			NotepadXCollection childsForSelectedNote = m_NotepadXDocument.GetChildNotes(noteId);
		...
		{
			AddNewChildNoteForSelectedNode(NoteFormat.FORMAT_DEFAULT);
		}
		...
		public void RemoveNoteForSelectedNote()
		{
			...
			else
			{
				...
				CatNoteDetail noteDetailToDelete = m_NotepadXDocument.GetNoteById(selectedNoteId);
		...
		public TreeNode LoadTreeNodes(NotepadXCollection notesCollectionForCategory, TreeNode rootNodeForCategory, string treeNodeIdToReturn)
		{
