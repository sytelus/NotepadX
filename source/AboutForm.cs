...
namespace Sytel.NotepadX
{
	...
	public class AboutForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.assemblyInfoViewerUserControl1 = new Sytel.AssemblyCustomProperty.AssemblyInfoViewerUserControl();
			...
			this.lblVersion.Location = new System.Drawing.Point(73, 28);
			...
			this.lblPartner.Size = new System.Drawing.Size(77, 16);
			...
			this.linkProduct.LinkArea = new System.Windows.Forms.LinkArea(0, 0);
			this.linkProduct.Location = new System.Drawing.Point(128, 8);
			this.linkProduct.Name = "linkProduct";
			this.linkProduct.Size = new System.Drawing.Size(67, 16);
			...
			this.linkCompany.LinkArea = new System.Windows.Forms.LinkArea(0, 0);
			this.linkCompany.Location = new System.Drawing.Point(128, 23);
			this.linkCompany.Name = "linkCompany";
			this.linkCompany.Size = new System.Drawing.Size(77, 16);
		...
		{
			AssemblyAttributeInfo thisAssemblyAttributeInfo = new AssemblyAttributeInfo(System.Reflection.Assembly.GetExecutingAssembly());
...
" + thisAssemblyAttributeInfo.CopyrightText;
			...
			linkProduct.LinkArea=new LinkArea(0,linkProduct.Text.Length);
			linkProduct.Links[0].LinkData = thisAssemblyAttributeInfo.ProductHomepageUrl;
			linkCompany.Text = thisAssemblyAttributeInfo.CompanyUrl;
			linkCompany.LinkArea=new LinkArea(0,linkCompany.Text.Length);
			linkCompany.Links[0].LinkData = thisAssemblyAttributeInfo.CompanyUrl;

			assemblyInfoViewerUserControl1.AssmblyToUse = Assembly.GetExecutingAssembly();
		}
